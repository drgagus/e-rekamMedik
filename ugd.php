...
<form action="menu.php" method="POST">
<input type="submit" name="rekapitulasipasienugd" value="REKAPITULASI" Style="WIDTH:120"; /> 
</form>
<h4><b>SELAMAT DATANG <?php echo $_SESSION['nama'] ; ?></b></h4>

<table Style="background:lightblue"; >
<form action="ugd.php" method="POST" >
...
<?php 
	...
	while($pasien = mysqli_fetch_array($query)){
			...
			echo "<td>" ;
            echo "<a href='unitgawatdarurat.php?nik=".$pasien['nik']."'>UGD</a>";
			echo "</td>";
