...
<form action="menu.php" method="POST">
<input type="submit" name="antrianpoligigi" value="ANTRIAN PASIEN" Style="WIDTH:120"; /> 
<input type="submit" name="rekapitulasipasiengigi" value="REKAPITULASI" Style="WIDTH:120"; /> 
</form>

<h4><b>SELAMAT DATANG <?php echo $_SESSION['nama'] ; ?></b></h4>

<table Style="background:lightblue"; >
<form action="poligigi.php" method="POST" >
