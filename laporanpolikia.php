...
<center>
<table>
	<tr><td><b><center>LAPORAN PELAYANAN POLI KIA</center></b></td></tr>
...
<?php 
	...
	if(isset($_POST['OK'])){
		$bulan = $_POST['bulan'];
		$tahun = $_POST['tahun'];
		$sql = " select * from perawatan JOIN datapasien using (nik) WHERE MONTH(tanggal) = $bulan AND YEAR (tanggal) = $tahun AND poli='POLI KIA' order by tanggal";
