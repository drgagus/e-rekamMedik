...
<center><h3><b style="background:yellow">POLI KESEHATAN UMUM</B><H3></center>
<table>
<tr><td>
<?php 
include("config.php");
	...
	echo "<table><tr><td><h4><a href='riwayatmedis.php?nik=".$pasien['nik']."' target='_blank' Style='color:darkblue';> RIWAYAT MEDIS</a><h4></td></tr><tr><td><br></td></tr><table>"; 
	}else{
	}
?>
</td></tr>
</table>
<form action="polidrproses.php" method="POST">
<table>
...
<table  style="width: 100%">
	...
	<input type="hidden"  name="poliasal" value="POLI UMUM" />
</table>
</fieldset>
<table style="width: 100%">
	<tr><td><br></td></tr>
