...
<center><h3><b style="background:yellow">POLI KESEHATAN GIGI DAN MULUT</B><H3></center>
<table>
<tr><td>
<?php 
include("config.php");
	...
	echo "<table><tr><td><h4><a href='riwayatmedis.php?nik=".$pasien['nik']."' target='_blank' Style='color:darkblue';> RIWAYAT MEDIS</a> | <a href='odontogram.php?nik=".$pasien['nik']."' Style='color:darkblue';> ODONTOGRAM </a><h4></td></tr><tr><td><br></td></tr><table>"; 
	}else{
	}
?>
</td></tr>
</table>
<form action="polidrgproses.php" method="POST">
<table>
...
<table  style="width: 100%">
	...
	<input type="hidden"  name="poliasal" value="POLI GIGI" />
</table>
</fieldset>
<table style="width: 100%">
	<tr><td><br></td></tr>
